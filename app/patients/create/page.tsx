...
export default function PatientCreatePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert('利用者を作成しました（バックエンド実装時にDB登録）');
    ...
    <MainLayout>
      <div className="p-4 md:p-6">
        ...
        <div className="mb-6 flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-gray-800">利用者作成</h1>
        </div>
              ...
              <div>
                ...
                >
                  ...
                  {mockDoctorData
                    ...
                    .map((doctor) => (
                      <option key={doctor.id} value={doctor.hospital}>
                        {doctor.hospital}
                      </option>
                    ))}
                </select>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="">選択してください</option>
                  {mockCareManagerData
                    .filter((manager) => manager.status === '利用中')
                    .map((manager) => (
                      <option key={manager.id} value={manager.office}>
                        {manager.office}
                      </option>
                    ))}
                </select>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, emergencyName1: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="山田花子（娘）"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, emergencyName2: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="山田次郎（息子）"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="">選択してください</option>
                  {mockPharmacyData
                    .filter((pharmacy) => pharmacy.status === '利用中')
                    .map((pharmacy) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, mealAssistance: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">選択してください</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, bathAssistTime: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">選択してください</option>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, hitomeQConsent: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">選択してください</option>
