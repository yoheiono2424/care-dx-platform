...
import { useAuth, MENU_PERMISSIONS, Position } from '@/contexts/AuthContext';
...
const menuItems: MenuItem[] = [
  { id: 'tasks', label: '行動タスク', icon: 'task', href: '/tasks' },
  { id: 'vital', label: 'バイタル', icon: 'vital', href: '/vitals' },
  { id: 'urine', label: '尿検査', icon: 'urine', href: '/urine-tests' },
  { id: 'behavior', label: '行動データ', icon: 'behavior', href: '/behavior' },
  { id: 'meal', label: '食事記録', icon: 'meal', href: '/meals' },
  {
    id: 'intervention',
    label: '介入実績',
    icon: 'intervention',
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const filteredMenuItems = useMemo(() => {
    return menuItems.filter((item) => {
      const requiredPermission = MENU_PERMISSIONS[item.id] as Position;
